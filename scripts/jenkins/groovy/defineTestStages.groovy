def call(final pipelineContext) {
  ...
  def BENCHMARK_STAGES = [
    [
      ...
      nodeLabel: pipelineContext.getBuildConfig().getBenchmarkNodeLabel(), customData: [algorithm: 'gbm'], makefilePath: pipelineContext.getBuildConfig().BENCHMARK_MAKEFILE_PATH
    ],
    [
